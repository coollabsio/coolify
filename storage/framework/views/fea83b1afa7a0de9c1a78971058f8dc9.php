...
<head>
    ...
    <?php use \App\Models\InstanceSettings; ?>
    <?php
    ...
    ?>
    <title><?php echo e($name); ?><?php echo e($title ?? 'Coolify'); ?></title>
    <?php if(app()->environment('local')): ?>
        <link rel="icon" href="<?php echo e(asset('coolify-logo-dev-transparent.png')); ?>" type="image/png" />
    <?php else: ?>
        <link rel="icon" href="<?php echo e(asset('coolify-logo.svg')); ?>" type="image/svg+xml" />
    <?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('app.name') == 'Coolify Cloud'): ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
        <script type="text/javascript" src="<?php echo e(URL::asset('js/echo.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('js/pusher.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('js/apexcharts.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(URL::asset('js/purify.min.js')); ?>"></script>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</head>
    ...
    <script data-navigate-once>
        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            window.Echo = new Echo({
                broadcaster: 'pusher',
                cluster: "<?php echo e(config('constants.pusher.host')); ?>" || window.location.hostname,
                key: "<?php echo e(config('constants.pusher.app_key')); ?>" || 'coolify',
                wsHost: "<?php echo e(config('constants.pusher.host')); ?>" || window.location.hostname,
                wsPort: "<?php echo e(getRealtime()); ?>",
                wssPort: "<?php echo e(getRealtime()); ?>",
                forceTLS: false,
                encrypted: true,
                enableStats: false,
                enableLogging: true,
