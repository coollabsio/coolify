...
It helps you manage your servers, applications, and databases on your own hardware — all you need is an SSH connection. You can manage VPS, Bare Metal, Raspberry PIs, and anything else.

Imagine having the ease of the cloud, but with your own servers.That is **Coolify**.
...
The recommended way to use Coolify is to run one server for Coolify itself and additional servers for the resources you deploy. A server is around 4-5$/month.
...
# Donations
To stay completely free and open-source, with no features behind a paywall, we need your help to continue evolving the project. If you like Coolify, please consider donating to help us fund the project's future development.
