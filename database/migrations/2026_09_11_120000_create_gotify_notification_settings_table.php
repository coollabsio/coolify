...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('gotify_notification_settings', function (Blueprint $table) {
            ...
            $table->boolean('restart_limit_reached_gotify_notifications')->default(true);
            ...
            $table->boolean('server_patch_gotify_notifications')->default(true);
            $table->boolean('traefik_outdated_gotify_notifications')->default(true);
