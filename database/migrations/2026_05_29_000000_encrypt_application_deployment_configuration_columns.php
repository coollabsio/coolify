...
return new class extends Migration
{
    ...
    {
        // SQLite (used for the in-memory test schema) is dynamically typed and
        // already stores these columns as text, so the Postgres-only TYPE change
        // is unnecessary there and the raw SQL would be a syntax error.
