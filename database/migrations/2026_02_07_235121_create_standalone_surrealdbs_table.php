...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('standalone_surrealdbs', function (Blueprint $table) {
            ...
            $table->longText('surrealdb_conf')->nullable();
            ...
            $table->string('image')->default('surrealdb/surrealdb:v2');
            ...
            $table->longText('custom_docker_run_options')->nullable();
        ...
        Schema::table('environment_variables', function (Blueprint $table) {
            $table->foreignId('standalone_surrealdb_id')->nullable();
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('environment_variables', function (Blueprint $table) {
            $table->dropColumn('standalone_surrealdb_id');
        });
    }
};
