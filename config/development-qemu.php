...
return [
    ...
    'legacy_domains' => ['coolify-dev-node-worker'],
    'profiles' => [
        'node-worker-a' => [
            'label' => 'Coolify worker node A (Ubuntu 24.04, Podman)',
            'domain' => 'coolify-dev-node-worker-a',
            'uuid' => 'development-qemu-node-worker-a',
            'name' => 'QEMU worker node A',
            'ip' => '192.168.122.50',
            'user' => 'root',
        ...
        'node-worker-b' => [
            'label' => 'Coolify worker node B (Ubuntu 24.04, Podman)',
            'domain' => 'coolify-dev-node-worker-b',
            'uuid' => 'development-qemu-node-worker-b',
            'name' => 'QEMU worker node B',
            'ip' => '192.168.122.51',
            'user' => 'root',
            'mac' => '52:54:00:ca:00:0a',
            'image' => 'ubuntu-noble-amd64.qcow2',
            'image_url' => 'https://cloud-images.ubuntu.com/noble/current/noble-server-cloudimg-amd64.img',
            'os_variant' => 'ubuntu24.04',
            'provisioner' => 'apt',
