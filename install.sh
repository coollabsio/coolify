...
#################################'
        docker run --rm -v /var/run/docker.sock:/var/run/docker.sock -v /data/coolify:/data/coolify -u root -w /usr/src/app coolify-base bash -x /usr/src/app/scripts/install.sh
    #   preTasks
...
################################'
        docker run --rm -v /var/run/docker.sock:/var/run/docker.sock -v /data/coolify:/data/coolify -u root -w /usr/src/app coolify-base bash -x /usr/src/app/scripts/upgrade-p1.sh
        # preTasks
...
################################'
        docker run --rm -v /var/run/docker.sock:/var/run/docker.sock -v /data/coolify:/data/coolify -u root -w /usr/src/app coolify-base bash -x /usr/src/app/scripts/upgrade-p2.sh
