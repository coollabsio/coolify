...
- Add terminal file upload functionality
- *(terminal)* Add "Previously Uploaded Files" table and improve UI
- Add formatBytes function and update file size display in file import view for terminal page
...
- *(security)* Enhance file upload security and cleanup processes for terminal file upload
- *(terminal)* Update filename parsing regex and improve directory cleanup logic
...
- Replace security notice with a callout component for better readability
