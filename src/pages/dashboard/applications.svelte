              ...
              <div class="flex items-center">
                {#if application.Spec.Labels.configuration.build.pack === "static"}
                  <svg
                    ...
                    ></svg
                  >
                {:else if application.Spec.Labels.configuration.build.pack === "react"}
                  <svg
                  ...
                  {:else if application.Spec.Labels.configuration.build.pack === "gatsby"}
                  ...
                  {:else if application.Spec.Labels.configuration.build.pack === "nuxtjs"}
                ...
                {:else if application.Spec.Labels.configuration.build.pack === "svelte"}
                  <svg
                ...
                {:else if application.Spec.Labels.configuration.build.pack === "vuejs"}
                  <svg
                ...
                {:else if application.Spec.Labels.configuration.build.pack === "nextjs"}
                  <svg
                ...
                {:else if application.Spec.Labels.configuration.build.pack === "docker"}
                  <svg
                    viewBox="0 0 128 128"
