...
class PgBackrestService
{
    ...
    /**
     * Generate the entrypoint script that installs pgBackRest into the container.
     */
...
BASH;
    ...
    /**
     * Build command to create or verify a stanza.
     */
    ...
    /**
     * Build command to get backup info in JSON format.
     */
    ...
    /**
     * Build command to restore from backup.
     */
    ...
    /**
     * Build command to run expire (retention cleanup).
     */
    ...
    /**
     * Get the PostgreSQL WAL archiving command parameters.
     */
    ...
    /**
     * Get the stanza name derived from the database UUID.
     */
    ...
    /**
     * Get the pgBackRest configuration directory path.
     */
    ...
    public function buildSetupCommands(?S3Storage $s3 = null): array
    {
        ...
        // Create pgBackRest config directory on host
    ...
    /**
     * Build commands to run a backup inside the container.
     */
    ...
    /**
     * Build commands to get backup info from the container.
     */
