...
class LogDrains extends Component
{
    ...
    private function syncDataNewRelic(bool $toModel = false)
    {
        if ($toModel) {
    ...
    private function syncDataAxiom(bool $toModel = false)
    {
        if ($toModel) {
    ...
    private function syncDataCustom(bool $toModel = false)
    {
        if ($toModel) {
    ...
    private function syncData(bool $toModel = false, ?string $type = null)
    {
        if ($toModel) {
