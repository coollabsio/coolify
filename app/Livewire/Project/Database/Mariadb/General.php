...
class General extends Component
{
    ...
    public ?int $publicPortIdleTimeout = null;
    ...
    protected function rules(): array
    {
        return [
            ...
            'publicPortIdleTimeout' => 'nullable|integer|min:0',
    ...
    public function syncData(bool $toModel = false)
    {
        if ($toModel) {
            ...
            $this->database->public_port_idle_timeout = $this->publicPortIdleTimeout;
            ...
            $this->publicPortIdleTimeout = $this->database->public_port_idle_timeout;
