...
class General extends Component
{
    ...
    public int $publicPortTimeout = 0;
    ...
    protected function rules(): array
    {
        return [
            ...
            'publicPortTimeout' => 'nullable|integer|min:0',
    ...
    protected function messages(): array
    {
        return array_merge(
            ...
            [
                ...
                'publicPortTimeout.integer' => 'The Proxy Timeout must be an integer.',
                'publicPortTimeout.min' => 'The Proxy Timeout must be at least 0.',
    ...
    protected $validationAttributes = [
        ...
        'publicPortTimeout' => 'Proxy Timeout',
    ...
    public function syncData(bool $toModel = false)
    {
        if ($toModel) {
            ...
            $this->publicPortTimeout = $this->database->public_port_timeout ?? 0;
