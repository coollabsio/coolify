...
class General extends Component
{
    ...
    protected function messages(): array
    {
        return array_merge(
            ...
            [
                ...
                'publicPortTimeout.integer' => 'The Proxy Timeout must be an integer.',                'publicPortTimeout.integer' => 'The Proxy Timeout must be an integer.',
    ...
    protected $validationAttributes = [
        ...
        'publicPortTimeout' => 'Proxy Timeout',        'publicPortTimeout' => 'Proxy Timeout',
