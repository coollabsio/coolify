...
class General extends Component
{
    ...
    public ?string $surrealdbConf = null;
    ...
    protected function messages(): array
    {
        return array_merge(
            ...
            [
                ...
                'surrealdbUser.string' => 'The SurrealDB User must be a string.',
                'surrealdbPassword.required' => 'The SurrealDB Password field is required.',
                'surrealdbPassword.string' => 'The SurrealDB Password must be a string.',
    ...
    public function syncData(bool $toModel = false)
    {
        if ($toModel) {
            ...
            $this->database->surrealdb_conf = $this->surrealdbConf;
            ...
            $this->surrealdbConf = $this->database->surrealdb_conf;
    ...
    public function regenerateSslCertificate()
    {
        try {
            ...
            // Use database UUID as commonName if not set
            $commonName = $existingCert->commonName ?? $this->database->uuid;
