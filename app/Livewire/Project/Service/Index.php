...
class Index extends Component
{
    ...
    private function syncDatabaseData(bool $toModel = false): void
    {
        if ($toModel) {
            ...
            $this->serviceDatabase->proxy_timeout = $this->proxyTimeout;
            ...
            $this->proxyTimeout = $this->serviceDatabase->proxy_timeout;
    ...
    public function submitDatabase()
    {
        try {
            $this->authorize('update', $this->serviceDatabase);
            $this->validate();
            if (str($this->proxyTimeout)->isEmpty()) {
                $this->proxyTimeout = null;
            }
            $this->syncDatabaseData(true);
