...
class Advanced extends Component
{
    ...
    #[Validate('boolean')]
    public bool $oauth_allow_registration;
    ...
    public function mount()
    {
        ...
        $this->oauth_allow_registration = $this->settings->oauth_allow_registration;
    ...
    public function instantSave()
    {
        try {
            ...
            $this->settings->oauth_allow_registration = $this->oauth_allow_registration;
