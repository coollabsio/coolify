...
class DeploySimpleDockerfileAction extends DeploymentBaseAction
{
    ...
    private function addBuildEnvVariablesToDockerfile(): void
    {
    ...
    private function writeDockerfileBase64(string $dockerFileContents, bool $hidden = false): void
    {
        $deployment = $this->getContext()->getApplicationDeploymentQueue();
        $config = $this->getContext()->getDeploymentConfig();
        $dockerFileLocation = $this->getContext()->getDeploymentResult()->getDockerfileLocation();
