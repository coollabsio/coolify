...
class ApplicationsController extends Controller
{
                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            'github_app_uuid' => ['type' => 'string', 'nullable' => true, 'description' => 'The Github App UUID.'],
                            'git_repository' => ['type' => 'string', 'description' => 'The git repository URL.'],
                            'git_branch' => ['type' => 'string', 'description' => 'The git branch.'],
                            'ports_exposes' => ['type' => 'string', 'description' => 'The ports to expose.'],
                            'destination_uuid' => ['type' => 'string', 'description' => 'The destination UUID.'],
    ...
    public function update_by_uuid(Request $request)
    {
        ...
        $validationRules = [
            ...
            'github_app_uuid' => 'string|nullable',
        ...
        if ($request->has('github_app_uuid')) {
            $githubAppUuid = $request->input('github_app_uuid');
            if (is_null($githubAppUuid)) {
                $application->source_type = null;
                $application->source_id = null;
                ...
                if ($application->source_id !== $githubApp->id || $application->source_type !== $githubApp->getMorphClass()) {
                    $application->repository_project_id = null;
                }
                $application->source_type = $githubApp->getMorphClass();
                $application->source_id = $githubApp->id;
