...
class ApplicationsController extends Controller
{
                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            'use_coolify_json' => ['type' => 'boolean', 'default' => true, 'description' => 'Check repository for coolify.json and apply configuration if found. Default is true.'],
    ...
    private function create_application(Request $request, $type)
    {
        ...
        $useCoolifyJson = $request->boolean('use_coolify_json', true);
