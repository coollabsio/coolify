...
class ApplicationsController extends Controller
{
                ...
                new OA\MediaType(
                    ...
                    schema: new OA\Schema(
                        ...
                        properties: [
                            ...
                            'is_deploy_on_release_enabled' => ['type' => 'boolean', 'description' => 'The flag to indicate if deploy on GitHub release is enabled. Defaults to false.'],
    ...
    private function create_application(Request $request, $type)
    {
        ...
        $isDeployOnReleaseEnabled = $request->is_deploy_on_release_enabled;
        ...
        if ($type === 'public') {
            ...
            if (isset($isDeployOnReleaseEnabled)) {
                $application->settings->is_deploy_on_release_enabled = $isDeployOnReleaseEnabled;
                $application->settings->save();
            }
