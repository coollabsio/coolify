...
#[OA\Schema(
    ...
    properties: [
        ...
        'day_condition' => ['type' => 'string', 'nullable' => true, 'description' => 'Optional day-of-week condition (cron DOW field) that must also match. Combined with frequency using AND logic.'],
