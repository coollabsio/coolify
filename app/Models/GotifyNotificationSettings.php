...
class GotifyNotificationSettings extends Model
{
    ...
    protected $fillable = [
        ...
        'restart_limit_reached_gotify_notifications',
        ...
        'traefik_outdated_gotify_notifications',
    ];
    ...
    protected $casts = [
        ...
        'restart_limit_reached_gotify_notifications' => 'boolean',
        ...
        'traefik_outdated_gotify_notifications' => 'boolean',
    ];
