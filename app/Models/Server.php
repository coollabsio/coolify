...
class Server extends BaseModel
{
    ...
    public function setupTlsConfiguration()
    {
        $proxy_path = $this->proxyPath();
        $proxy_type = $this->proxyType();
        $dynamic_config_path = $proxy_path.'/dynamic';

        if (is_null($proxy_type) || $proxy_type === 'NONE') {
            return;
        }
        ...
        if ($proxy_type === ProxyTypes::TRAEFIK->value) {
            ...
            $tls_yaml = Yaml::dump($tls_config, 12, 2);
            $tls_yaml = "# This file is automatically generated by Coolify.\n# TLS configuration - Do not edit manually.\n\n".$tls_yaml;
            $tls_base64 = base64_encode($tls_yaml);
            instant_remote_process([
                "echo '$tls_base64' | base64 -d | tee $dynamic_config_path/tls.yaml > /dev/null",
            ], $this);

            $hsts_yaml = Yaml::dump($hsts_config, 12, 2);
            $hsts_yaml = "# This file is automatically generated by Coolify.\n# HSTS middleware - Do not edit manually.\n\n".$hsts_yaml;
            $hsts_base64 = base64_encode($hsts_yaml);
            instant_remote_process([
                "echo '$hsts_base64' | base64 -d | tee $dynamic_config_path/hsts.yaml > /dev/null",
            ], $this);

            $ocsp_yaml = Yaml::dump($ocsp_config, 12, 2);
            $ocsp_yaml = "# This file is automatically generated by Coolify.\n# OCSP configuration - Do not edit manually.\n\n".$ocsp_yaml;
            $ocsp_base64 = base64_encode($ocsp_yaml);
            instant_remote_process([
                "echo '$ocsp_base64' | base64 -d | tee $dynamic_config_path/ocsp.yaml > /dev/null",
            ], $this);
        } elseif ($proxy_type === ProxyTypes::CADDY->value) {
            $caddy_tls_config = "
# This file is automatically generated by Coolify.
# TLS security configuration - Do not edit manually.
...
";
            $caddy_tls_file = "$dynamic_config_path/security.caddy";
            $caddy_tls_base64 = base64_encode($caddy_tls_config);
            instant_remote_process([
                "echo '$caddy_tls_base64' | base64 -d | tee $caddy_tls_file > /dev/null",
            ], $this);
            $this->reloadCaddy();
        }
    }
