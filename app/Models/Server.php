...
use function str;
use function refresh_server_connection;
use function instant_remote_process;
use function instant_remote_process_with_timeout;
use function filled;
use function instanceSettings;
use function isCloud;
use function isDev;
use function currentTeam;
use function once;
use function now;
use function format_docker_command_output_to_json;
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\StandaloneDocker[] $standaloneDockers
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\SwarmDocker[] $swarmDockers
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Service[] $services
 * @method \Illuminate\Support\Collection applications()
 * @method \Illuminate\Support\Collection databases()
 * @property array{
 *     current: string,
 *     latest: string,
