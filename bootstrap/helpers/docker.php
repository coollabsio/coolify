...
/**
 * Whether a domain must be served with an X-Robots-Tag: noindex, nofollow header.
 *
 * Both sides are normalized so that a casing difference between the flag and the
 * configured domain cannot silently drop the header.
 *
