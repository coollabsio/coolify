...
<div class="flex flex-col items-center justify-center h-full">
    <div>
        ...
        <h1 class="mt-4 font-bold tracking-tight dark:text-white">{{ __('error.419.title') }}</h1>
        <p class="text-base leading-7 dark:text-neutral-300 text-black">{{ __('error.419.body') }}
        </p>
