<div class="sub-menu-wrapper">
    ...
    @if ($server->isFunctional())
        ...
        <a class="sub-menu-item {{ $activeMenu === 'docker-networks' ? 'menu-item-active' : '' }}" {{ wireNavigate() }}
            href="{{ route('server.docker-networks', ['server_uuid' => $server->uuid]) }}"><span class="menu-item-label">Docker Networks</span>
        </a>
