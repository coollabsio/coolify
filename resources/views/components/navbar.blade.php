        ...
        <li class="flex-1 overflow-x-hidden">
            <ul role="list" class="flex flex-col h-full space-y-1.5">
                @if (isSubscribed() || !isCloud())
                    <li>
                        <a wire:navigate.hover title="Dashboard" href="/"
                    ...
                    <li>
                        <a wire:navigate.hover title="Projects"
                    ...
                    <li>
                        <a wire:navigate.hover title="Servers"
                    ...
                    <li>
                        <a wire:navigate.hover title="Sources"
                    ...
                    <li>
                        <a wire:navigate.hover title="Destinations"
                    ...
                    <li>
                        <a wire:navigate.hover title="S3 Storages"
                    ...
                    <li>
                        <a wire:navigate.hover title="Shared variables"
                    ...
                    <li>
                        <a wire:navigate.hover title="Notifications"
                    ...
                    <li>
                        <a wire:navigate.hover title="Keys & Tokens"
                    ...
                    <li>
                        <a wire:navigate.hover title="Tags"
                    ...
                    @can('canAccessTerminal')
                        <li>
                            <a wire:navigate.hover title="Terminal"
                    ...
                    @endcan
                    <li>
                        <a wire:navigate.hover title="Profile"
                    ...
                    <li>
                        <a wire:navigate.hover title="Teams"
                    ...
                    @if (isCloud() && auth()->user()->isAdmin())
                        <li>
                            <a wire:navigate.hover title="Subscription"
                    ...
                    @if (isInstanceAdmin())
                        <li>
                            ...
                            <a wire:navigate.hover title="Settings"
                        ...
                        @if (isInstanceAdmin() || session('impersonating'))
                            <li>
                                <a title="Admin" class="menu-item" href="/admin">
                                    <svg class="text-pink-500 icon" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                                        <path fill="currentColor"
