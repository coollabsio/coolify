        ...
        <li class="flex-1 overflow-x-hidden">
            <ul role="list" class="flex flex-col h-full space-y-1.5">
                @if (isSubscribed() || !isCloud())
                    ...
                    <li>
                        <a title="Notification History"
                            class="{{ request()->is('notifications') && !request()->is('notifications/*') ? 'menu-item-active menu-item' : 'menu-item' }}"
                    ...
                    <li>
                        <a title="Notification Settings"
                            ...
                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                <path fill="none" stroke="currentColor" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 1 1-6 0a3 3 0 0 1 6 0" />
                            </svg>
