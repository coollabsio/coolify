        ...
        <li class="flex-1 overflow-x-hidden">
            <ul role="list" class="flex flex-col h-full space-y-1.5">
                @if (isSubscribed() || !isCloud())
                    <li>
                        <a wire:navigate title="Dashboard" href="/"
                    ...
                    <li>
                        <a wire:navigate title="Projects"
                    ...
                    <li>
                        <a wire:navigate title="Destinations"
                    ...
                    <li>
                        <a wire:navigate title="S3 Storages"
                    ...
                    <li>
                        <a wire:navigate title="Shared variables"
                    ...
                    <li>
                        <a wire:navigate title="Notifications"
                    ...
                    <li>
                        <a wire:navigate title="Keys & Tokens"
                    ...
                    @can('canAccessTerminal')
                        <li>
                            <a wire:navigate title="Terminal"
                    ...
                    @if (isCloud() && auth()->user()->isAdmin())
                        <li>
                            <a wire:navigate title="Subscription"
                    ...
                    @if (isInstanceAdmin())
                        <li>
                            ...
                            <a wire:navigate title="Settings"
