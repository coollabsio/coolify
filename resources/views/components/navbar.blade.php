@auth
    <nav class="fixed h-full pt-28 scrollbar">
        ...
        <ul class="flex flex-col h-full gap-4 menu flex-nowrap">
            ...
            <div class="pt-4 dropdown dropdown-right">
                <li>
                    ...
                    <ul tabindex="0" class="dropdown-content rounded z-[1] menu p-2 bg-coolgray-100 w-64">
                        <li title="Tags" class="hover:bg-coolgray-200">
