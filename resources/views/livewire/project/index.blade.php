                ...
                <div class="box group cursor-pointer" @click="$wire.navigateToProject(project.uuid)">
                    <div class="flex flex-1 mx-6">
                        ...
                        <div class="relative z-10 flex items-center justify-center gap-4 text-xs font-bold"
                            ...
                            <a wire:navigate.hover class="hover:underline" wire:click.stop
                                x-show="project.addResourceRoute" :href="project.addResourceRoute">
                                + Add Resource
                            </a>
                            <a wire:navigate.hover class="hover:underline" wire:click.stop x-show="project.canUpdate"
