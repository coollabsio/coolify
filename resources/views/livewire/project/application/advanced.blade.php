    ...
    <div class="flex flex-col md:w-96">
        ...
        <div class="flex flex-col gap-1 pt-4">
            ...
            @if ($application->git_based())
                ...
                <x-forms.checkbox
                    helper="Automatically deploy when a new GitHub release is published. Requires the 'release' webhook event to be enabled in your GitHub repository or app settings."
