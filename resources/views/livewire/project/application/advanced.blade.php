        ...
        <div class="flex flex-col gap-1 pt-4">
            ...
            @if ($application->git_based())
                ...
                <x-forms.checkbox
                    ...
                    :canResource="$application" />
                <x-forms.checkbox
                    helper="When enabled, anyone can trigger PR deployments. When disabled, fork PRs are blocked and only repository members, collaborators, and contributors can trigger PR deployments."
