<div class="form-page">
    <div class="form-card md:w-96">
        <div class="form-section-title">
            <h2>Advanced</h2>
        </div>
        <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Advanced configuration for your application.</p>
    </div>
    <div class="form-subsection md:w-96">
        <h3>General</h3>
    ...
    @endif
    @if ($application->build_pack !== 'dockercompose')
        <form wire:submit="submit" class="form-subsection">
            <div class="form-section-title">
                <h3>GPU</h3>
