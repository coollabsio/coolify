<div>
    ...
    <div>
        ...
        @elseif(!$resource->destination->server->isMetricsEnabled())
            ...
            <div>Go to <a wire:navigate.hover class="underline dark:text-white"
                    href="{{ route('server.show', $resource->destination->server->uuid) }}">Server settings</a> to enable
                it.</div>
        @else
            ...
            @else
                <div>
                    ...
                    <div @if ($poll) wire:poll.5000ms='pollData' @endif x-init="$wire.loadData()" class="pt-5">
                        <h4>CPU Usage</h4>
