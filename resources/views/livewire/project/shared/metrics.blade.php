<div>
    ...
    <div>
        ...
        @elseif(!$resource->destination->server->isMetricsEnabled())
            ...
            <div>Go to <a wire:navigate.hover class="underline dark:text-white" href="{{ route('server.show', $resource->destination->server->uuid) }}">Server settings</a> to enable it.</div>
        @else
