<div wire:init="refreshNetworksInBackground" class="flex flex-col gap-6">
    <div class="box-without-bg flex flex-col gap-4">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <div class="text-sm text-neutral-500">Connect this resource to Docker networks managed by Coolify.</div>
            </div>
        ...
        @elseif ($availableNetworks->isEmpty())
            <div class="text-sm text-neutral-500">
                No Docker networks found for this server. Create or import one from Server > Docker Networks.
            </div>
        @endif
    ...
    <div class="box-without-bg flex flex-col gap-4">
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            @if ($managedNetworkMode)
                <x-status-badge status="Managed by Coolify" type="neutral" />
            @endif
        </div>
