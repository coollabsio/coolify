                                            ...
                                            <tr class="border-b border-coolgray-200 dark:border-coolgray-700 hover:bg-coolgray-50 dark:hover:bg-coolgray-800 {{ $isSelected ? 'bg-blue-50 dark:bg-blue-900/20' : '' }}">
                                                ...
                                                <td class="p-2">
                                                    <div class="flex items-center justify-end gap-1">
                                                        ...
                                                        <x-modal-confirmation :ignoreWire="false" title="Delete File?" buttonTitle="Delete" submitAction="deleteFile('{{ $filePathEscaped }}')" :confirmWithText="false" :confirmWithPassword="false" step1ButtonText="Delete" step2ButtonText="Confirm">
                                            <x-slot:content>
