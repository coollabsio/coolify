<div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'general' }">
    <div class="flex gap-4 pb-6 border-b border-coolgray-700">
        <button 
            @click.prevent="activeTab = 'general'; window.location.hash = 'general'"
            :class="activeTab === 'general' ? 'text-white border-b-2 border-coollabs' : 'text-coolgray-400 hover:text-white'" 
            class="pb-2 transition-all"
        >
            General
        </button>
        <button 
            @click.prevent="activeTab = 'import'; window.location.hash = 'import'"
            :class="activeTab === 'import' ? 'text-white border-b-2 border-coollabs' : 'text-coolgray-400 hover:text-white'" 
            class="pb-2 transition-all"
        >
            Import Backup
        </button>
    ...
    <div x-cloak x-show="activeTab === 'import'" class="pt-4">
