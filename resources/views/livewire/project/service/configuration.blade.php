        ...
        <div class="flex flex-col h-full gap-8 sm:flex-row">
            <div class="flex flex-col items-start gap-2 min-w-fit">
                <a class="menu-item sm:min-w-fit" target="_blank" href="{{ $service->documentation() }}">Documentation
                    <x-external-link /></a>
                <a wire:navigate.hover class='menu-item' wire:current.exact="menu-item-active"
            ...
            <div class="w-full">
                            ...
                            <div @class([
                                ...
                                <div class="flex flex-row w-full">
                                            ...
                                            <span class="flex gap-1 text-xs">{{ Str::limit($application->fqdn, 60) }}
                                                @can('update', $service)
                                                    <x-modal-input title="Edit Domains" :closeOutside="false">
                                                        <x-slot:content>
                                                            <span class="cursor-pointer">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="w-4 h-4 dark:text-warning text-coollabs" viewBox="0 0 24 24">
                                                        ...
                                                        <livewire:project.service.edit-domain applicationId="{{ $application->id }}"
                                    ...
                                    <div class="flex items-center px-4">
                                        <a wire:navigate.hover class="mx-4 text-xs font-bold hover:underline"
                                        ...
                                        @if (str($application->status)->contains('running'))
                                            @can('update', $service)
                                                            <x-modal-confirmation title="Confirm Service Application Restart?" buttonTitle="Restart"
                                                    ...
                                                    'If the service application is currently in use data could be lost.',
                                                               ...
                                                               :confirmWithText="false" :confirmWithPassword="false" step2ButtonText="Restart Service Container" />
                                            @endcan
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-row w-full">
                                    ...
                                    <div class="flex items-center px-4">
                                        ...
                                        @if (str($database->status)->contains('running'))
                                            @can('update', $service)
                                                            <x-modal-confirmation title="Confirm Service Database Restart?" buttonTitle="Restart"
                                                                submitAction="restartDatabase({{ $database->id }})" :actions="[
                ...
                @elseif ($currentRoute === 'project.service.storages')
                    ...
                    <div class="pb-4 dark:text-warning text-coollabs">If you would like to add a volume, you must add it to
                        your compose file (<a wire:navigate.hover class="underline"
