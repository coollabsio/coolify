                    ...
                    <form wire:submit='submitDatabase'>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <x-forms.input canGate="update" :canResource="$serviceDatabase" placeholder="0"
                                    id="publicPortTimeout" label="Proxy Timeout (seconds)"
                                    helper="Timeout in seconds for the public database proxy. Set to 0 to use the default (10 minutes). Useful for long-running queries." />
                                @if ($db_url_public)
