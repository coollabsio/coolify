<div>
    <form wire:submit="submit" class="flex flex-col gap-2">
        ...
        @if ($database->started_at)
            <div class="flex gap-2">
                <x-forms.input label="Initial Username" id="surrealdbUser" readonly
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex items-end gap-2">
                <x-forms.input placeholder="3000:8000" id="portsMappings" label="Ports Mappings"
                    helper="A comma separated list of ports you would like to map to the host system.<br><span class='inline-block font-bold dark:text-warning'>Example</span>3000:8000,3002:8000"
        ...
        <x-forms.textarea
            helper="Custom SurrealDB configuration options. You can add additional startup parameters here."
            label="Custom SurrealDB Configuration" rows="10" id="surrealdbConf" canGate="update" :canResource="$database" />
    </form>
