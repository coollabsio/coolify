    ...
    <form wire:submit="submit" class="flex flex-col gap-2">
        ...
        <div class="flex gap-2">
            ...
            <x-forms.input label="{{ __('application.image') }}" id="image" required canGate="update" :canResource="$database"
                helper="{{ __('database.image_helper_keydb') }}" />
        </div>

        @if ($database->started_at)
            <div class="flex gap-2">
                <x-forms.input label="{{ __('database.initial_password') }}" id="keydbPassword" type="password" required readonly
        ...
        @else
            ...
            <div class="flex gap-2">
                <x-forms.input label="{{ __('database.password') }}" id="keydbPassword" type="password" required canGate="update"
        ...
        <x-forms.textarea
            helper="{{ __('database.custom_keydb_config_helper') }}"
            label="{{ __('database.custom_keydb_config') }}" rows="10" id="keydbConf" canGate="update" :canResource="$database" />
    </form>
