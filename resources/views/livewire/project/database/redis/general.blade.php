        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex items-end gap-2">
                <x-forms.input placeholder="3000:6379" id="portsMappings" label="Ports Mappings"
                    helper="A comma separated list of ports you would like to map to the host system.<br><span class='inline-block font-bold dark:text-warning'>Example</span>3000:6379,3002:6379"
