<div>
    ...
    <p class="text-sm text-neutral-500 dark:text-neutral-400 -mt-4 mb-4">Manage users of this instance.</p>
    <div class="form-card">
        ...
        <div class="grid grid-cols-1 gap-2 lg:grid-cols-2">
            ...
            @empty
                <div class="empty-state">No users found other than the root.</div>
            @endforelse
            @if ($lots_of_users)
