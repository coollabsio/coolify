            ...
            <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
                @foreach ($projects as $project)
                    <div class="relative gap-2 cursor-pointer box group">
                        <a wire:navigate href="{{ $project->navigateTo() }}" class="absolute inset-0"></a>
        ...
        @else
            <div class="flex flex-col gap-1">
                ...
                <div class="flex items-center gap-1">
                    ...
                    go to the <a wire:navigate class="underline dark:text-white" href="{{ route('onboarding') }}">onboarding</a> page.
                </div>
            </div>
        @endif
    </section>
            ...
            @if ($privateKeys->count() === 0)
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center gap-1">Before you can add your server, first <x-modal-input
                        ...
                        or
                        go to the <a wire:navigate class="underline dark:text-white" href="{{ route('onboarding') }}">onboarding</a>
                        page.
                    </div>
                </div>
            @else
