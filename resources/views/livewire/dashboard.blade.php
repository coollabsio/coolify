                ...
                <div class="grid grid-cols-1 gap-4 xl:grid-cols-2">
                    @foreach ($projects as $project)
                        <div class="relative gap-2 cursor-pointer box group">
                            <a wire:navigate.hover href="{{ $project->navigateTo() }}" class="absolute inset-0"></a>
                                ...
                                <div class="relative z-10 flex items-center justify-center gap-4 text-xs font-bold">
                                    @if ($project->environments->first())
                                        @can('createAnyResource')
                                                        <a wire:navigate.hover class="hover:underline" href="{{ route('project.resource.create', [
                                    ...
                                    @endif
                                    @can('update', $project)
                                        <a wire:navigate.hover class="hover:underline"
            ...
            @else
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        go to the <a wire:navigate.hover class="underline dark:text-white"
