                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_oauth_registration_enabled"
                            helper="Allow users to self-register via OAuth providers even when general registration is disabled. Useful for controlling access through identity providers like Authentik or Keycloak."
