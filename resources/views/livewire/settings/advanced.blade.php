                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_oauth_registration_enabled"
                            helper="Allow new users to create accounts through enabled OAuth providers even when general registration is disabled."
                            label="OAuth Registration Allowed" />
                    </div>
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_oauth_password_login_disabled"
                            helper="Prevent OAuth-only users from setting a password through password reset. They must continue signing in with their OAuth provider."
                            label="OAuth Users Require OAuth Login" />
                    </div>
                    <div class="md:w-96">
