                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_oauth_registration_enabled"
                            helper="Allow OAuth users to self-register even when general registration is disabled. Useful for controlling access via external identity providers like Authentik."
