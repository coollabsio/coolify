<div class="flex flex-col gap-1">
    ...
    @else
        <div class="flex items-center justify-between gap-2 md:w-96" wire:key="registration-disabled">
            <label class="flex items-center gap-2"><div class="flex flex-col gap-1"><div class="flex flex-col gap-1">
    @if ($is_registration_enabled)
        <div class="md:w-96" wire:key="registration-enabled">
            <x-forms.checkbox instantSave id="is_registration_enabled"
                helper="Allow users to self-register. If disabled, only administrators can create accounts."
    ...
    @else
        <div class="flex items-center justify-between gap-2 md:w-96" wire:key="registration-disabled">
            <label class="flex items-center gap-2"><div class="flex flex-col gap-1">
    @if ($is_registration_enabled)
        <div class="md:w-96" wire:key="registration-enabled">
            <x-forms.checkbox instantSave id="is_registration_enabled"
                helper="Allow users to self-register. If disabled, only administrators can create accounts."
    ...
    @else
        <div class="flex items-center justify-between gap-2 md:w-96" wire:key="registration-disabled">
            <label class="flex items-center gap-2">
                ...
                <x-helper helper="Allow users to self-register. If disabled, only administrators can create accounts." />
            </x-helper>label>
    ...
    <h4 class="pt-4">DNS Settings</h4>h4>
    <div class="md:w-96">
        <x-forms.checkbox instantSave id="is_dns_validation_enabled"
            helper="Verify that custom domains are correctly configured in DNS before deployment. Prevents deployment failures from DNS misconfigurations."
            label="DNS Validation" />
    </x-forms.checkbox>div>
    </div>div><x-helper helper="Allow users to self-register. If disabled, only administrators can create accounts." />
            </x-helper>label>
            <x-modal-confirmation title="Enable Registration?" buttonTitle="Enable" isErrorButton
                submitAction="toggleRegistration" :actions="[
                    'Enables registration for everyone',
    ...
    </div>div><div class="md:w-96" wire:key="registration-enabled">
            <x-forms.checkbox instantSave id="is_registration_enabled"
                helper="Allow users to self-register. If disabled, only administrators can create accounts."
                label="Registration Allowed" />
        </x-forms.checkbox>div>
