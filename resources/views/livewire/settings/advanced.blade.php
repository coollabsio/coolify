                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_oauth_registration_enabled"
                            helper="Allow new users to self-register via OAuth providers (e.g. GitHub, Google) even when general registration is disabled. Existing OAuth users can always log in."
