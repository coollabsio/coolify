                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_oauth_only_registration_enabled"
                            helper="Allow users to self-register via OAuth providers even when general registration is disabled. Users who register through OAuth will not have a password and can only log in via their OAuth provider."
