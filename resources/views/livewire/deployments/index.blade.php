    ...
    <div class="flex flex-col gap-4 pb-10" @if ($deployments->currentPage() === 1) wire:poll.5000ms @endif>
        ...
        <div class="flex flex-col gap-3 md:flex-row md:items-end">
            <div class="w-full md:w-48">
                <x-forms.select id="project" label="Project" wire:model.live="project" wire:target="project">
                    <option value="all">All projects</option>
                    @foreach ($projectOptions as $value => $label)
            ...
            @if (count($serverOptions) > 1)
                <div class="w-full md:w-48">
                    <x-forms.select id="server" label="Server" wire:model.live="server" wire:target="server">
            ...
            <div class="w-full md:w-48">
                <x-forms.select id="status" label="Status" wire:model.live="status" wire:target="status">
        ...
        <div class="flex flex-col gap-2">
            ...
            @empty
                <div>No deployments found for the selected filters.</div>
            @endforelse
        </div>
