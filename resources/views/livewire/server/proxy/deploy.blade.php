...
<div>
    @if (
        ...
        <div wire:poll.5s="updateProxyStatus" x-data="{ proxyStatus: @entangle('proxyStatus').live }" x-init="$watch('proxyStatus', value => { console.log('Proxy status changed:', value); $wire.$refresh(); })">
