<div>
    <x-slot:title>
        ...
        <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'general' }"
            ...
            soon.<br/>Status notifications sent every week.<br/>You can disable notifications in the <a wire:navigate.hover class='dark:text-white underline' href='{{ route('notifications.email') }}'>notification settings</a>." />
                        @if (isDev())
                                ...
                                <div>
                                    ...
                                    @else
                                        ...
                                        @if (isset($updates) && count($updates) > 0)
                                            <div class="pb-2">
                                                <x-modal-confirmation title="Confirm package update?" buttonTitle="Update All
                                                    Packages" isHighlightedButton submitAction="updateAllPackages"
                                                    ...
                                                    shortConfirmationLabel="Name" :confirmWithPassword=false step2ButtonText="Update All
                                                    Packages" />
                                            </div>
                                            <table>
                                                <thead>
