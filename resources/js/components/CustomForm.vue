...
<template>
  <div v-if="isConfirmation" class="space-y-4">
    ...
    <Popover v-model:open="isOpen">
      <PopoverTrigger :disabled="!isFormValid || !isFormDirty">
        <div class="flex gap-2">
          <Button v-if="isSubmitting" type="submit" disabled="true">{{ customSavingText || 'Saving...' }}
      ...
      <PopoverContent align="start" class="w-full">
        <div class="grid gap-4">
          ...
          <div class="flex gap-2 justify-between">
            <Button type="button" variant="outline" @click="isOpen = false">No</Button>
            <Button type="submit" variant="destructive" :disabled="!isFormValid || !isFormDirty"
