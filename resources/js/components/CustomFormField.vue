    ...
    <FormField v-slot="{ componentField }" :name="field" :is-dirty="isFieldDirty">
        <FormItem class="w-full">
            <FormLabel class="flex items-center" v-if="type === 'text' || type === 'textarea' || type === 'select'">
                {{ !noLabel ? label || computedField : '' }}
                <span class="text-destructive px-1" v-if="!noLabel && isRequired">*</span>
            ...
            <Combobox v-model="componentField.modelValue" by="label" v-else-if="type === 'combobox'">
                <FormControl>
                    <ComboboxAnchor>
                        <ComboboxTrigger>
                    ...
                    <div class="flex flex-row items-center justify-between w-full">
                        <div class="space-y-0.5">
                            ...
                            <FormDescription>
                                ...
                                <div v-if="descriptionError" class="text-sm text-destructive"
                                    v-html="descriptionError" />
                            </FormDescription>
                        </div>
                        <FormControl>
