  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        variant === "ghost" && "h-auto border border-transparent bg-transparent px-0 py-0 text-sm font-medium text-foreground hover:bg-transparent focus-visible:border-transparent dark:bg-transparent dark:hover:bg-transparent",
        className
      )}
      {...props}>
      {children}
