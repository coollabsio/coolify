...
test('StandaloneDocker::databases() includes attached influxdb', function () {
    attachDb(StandaloneInfluxdb::class, ['influxdb_admin_password' => 'pw', 'influxdb_admin_token' => 'token'], $this->destination, $this->environment);
