...
it('reconciles a complete full mesh through durable typed operations', function () {
    ...
    Http::fake(function (Request $request) use ($requests) {
        ...
        return match (true) {
            ...
            str_ends_with($request->url(), 'network.firewall.reconcile') => Http::response([...$base, 'changed' => true, 'rollback_cancelled' => true, 'applied_revision' => $data['revision'], 'configuration_hash' => 'firewall-hash', 'drifted' => false, 'table' => 'coolify_cluster']),
