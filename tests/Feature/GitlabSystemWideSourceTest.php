...
test('ownedByCurrentTeam resolves a system-wide GitLab source owned by another team', function () {
    ...
    // Mirrors how Source::changeSource() resolves a selected source. Before the
    // fix this returned null for system-wide sources, causing a 404 even though
    // the source appears in the team's selectable source list.
