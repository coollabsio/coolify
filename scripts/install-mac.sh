#!/bin/bash
# Coolify installer for macOS (Docker Desktop / OrbStack / Colima). Uses Docker Desktop
# mode: coolify-testing-host acts as the localhost server, so no SSH into the Mac is needed.
