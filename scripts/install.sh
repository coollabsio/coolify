...
case "$OS_TYPE" in
    arch | manjaro | ubuntu | debian | raspbian | centos | fedora | rhel | ol | rocky | sles | opensuse-leap | opensuse-tumbleweed) ;;
    *)
        echo "This script only supports Debian, Redhat, SLES, Arch Linux, or Manjaro based operating systems for now."
        exit
        ;;
esac
